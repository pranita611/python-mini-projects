...
mycursor.execute("create table if not exists doctor_details(name varchar(30) primary key,specialisation varchar(40),age int(2),address varchar(30),contact varchar(15),fees int(10),monthly_salary decimal(10,2))")
mycursor.execute("create table if not exists nurse_details(name varchar(30) primary key,age int(2),address varchar(30),contact varchar(15),monthly_salary decimal(10,2))")
mycursor.execute("create table if not exists other_workers_details(name varchar(30) primary key,age int(2),address varchar(30),contact varchar(15),monthly_salary decimal(10,2))")
                    ...
                    while(True):
                        ...
                        if a==1:
                            ...
                            if b==1:
                                ...
                                doc=input("RECOMMENDED DOCTOR: ")
                                mycursor.execute ("insert into patient_details values('"+id+"','"+name+"','"+age+"','"+address+"','"+doc+"')")
                                mysql.commit()
                                mycursor.execute("select * from patient_details")
                                for i in mycursor:
                                    v=list(i)
